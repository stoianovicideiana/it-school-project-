...
public class Ch1CollegeManagementSystem {
    ...
    public static void main(String[] args) {
        Student student1 = new Student("Deiana", "Stoianovici", "Female", LocalDate.of(1997, 07, 24), new Address("Romania", "T'imisoara", "Arhitect Ion Mincu", 16), 26, "321232343243");
...
//Math, Computer Science, Physics, Chemistry, Biology, Geography, English, and History
        ...
        System.out.println("Student information: " + student1);
        System.out.println("English professor: " + professor2);
    }
}
